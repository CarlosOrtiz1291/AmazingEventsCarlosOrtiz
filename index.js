...
console.log(arrayEvents, arrayCategories)
...
const contenedorIndexCard = document.getElementById("contenedorIndexCard");
...
contenedorIndexCard.appendChild(contenedorTarjetas);
...
arrayMisCategorias.forEach((category) => {
    const checkbox = document.createElement("div");
    checkbox.classList.add("form-check", "gap-1", "d-flex", "justify-content-center", "align-self-center");
